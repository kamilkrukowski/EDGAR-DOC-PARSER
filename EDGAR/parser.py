...
class edgar_parser:
    ...
    Parses some documents (2001-2013) at least
        ...
        f -- the string of a html file path
    """
    def new_parse_unannotated_text(self, f, driver_path: str = '',
    ...
    def new_get_driver_path(self, tikr, submission, fname, partition='processed'):
        return pathlib.Path(os.path.join(self.data_dir, partition, tikr, submission, fname)).absolute()
    
    def new_parse_annotated_text(self, f, driver_path: str = '', highlight: bool = False, save: bool = False, out_path: str = os.path.join('.','sample.htm')):
        """
